...
export default function SocraticChat({ initialMessage }: SocraticChatProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl shadow-lg border border-slate-100">
      {/* Header */}
      <div className="p-4 border-b border-slate-100 bg-gradient-to-r from-blue-50 to-white rounded-t-2xl">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-slate-100">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-3 bg-blue-500 hover:bg-blue-600 disabled:bg-slate-300 disabled:cursor-not-allowed text-white rounded-xl transition-colors"
          >
